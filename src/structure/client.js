...
function printBox(title, items, color = "#000000") {
...
class MainClient extends Client {
  ...
  async ConnectMongo() {
    ...
    const mongoURI =
      this.config.Mongo ||
      "mongodb+srv://Pudding:pudding062004@pudding.1153jbn.mongodb.net/?appName=Pudding";

    try {
      await mongoose.connect(mongoURI);
      printBox("MONGODB", ["✅ Connected successfully"], "#000000");
      this.db = true;
    } catch (error) {
