  ...
  if (updateData) {
    try {
      ...
      const title = track
        ...
        : "__**Join a Voice Channel & Request a Song**__\n**Elevate Your Music Experience with Pudding**: Join Vc & Request a Song. We are here to Deliver The High Quality Music For You!";

      let embedl = new EmbedBuilder()
        .setColor(client.color)
        .setImage(`https://images-ext-1.discordapp.net/external/Iwyp9nW_4VThTq6aH_v_drML8WGia4qvhdqm2qrntvE/%3Fsize%3D4096/https/cdn.discordapp.com/banners/1340602825566195834/a_1799e4c8b9af657aaedb814800185b38.gif?width=1440&height=508`)
