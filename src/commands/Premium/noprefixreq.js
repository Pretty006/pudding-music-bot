    ...
    run: async (client, message, args, prefix) => {
        try {
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: "1. Boost Support Server", value: "- You can get NoPrefix by Boosting our [Support Server!](https://discord.gg/AuaXBZjGsn)" },
                    ...
                    { name: "3. Buying NoPrefix", value: "- The Buy System Is only for 1year noprefix price - ₹499 only." },
                     {name: "4. Staff Apply", value: "- The user can be a staff of the Pudding then get the noprefix for no any restrictions just apply or dm the developer for that."}
                )
