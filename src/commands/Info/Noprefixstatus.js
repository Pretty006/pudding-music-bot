...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const supportServerId = "1443190181371973795"; // Replace with your support server ID
    ...
    if (!data || (remaining !== null && remaining <= 0)) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          ...
          (isInSupportServer
            ? "You're in our support server! Contact a Owner to buy NoPrefix access."
            : "Join our support server to buy NoPrefix access!")
        )
