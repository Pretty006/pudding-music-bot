...
const webhook = new WebhookClient({
  url: "https://discord.com/api/webhooks/1452599376978645013/VWPC8lh_XV5qTMph_Id0qYkYrpLAF4ZPTeaJyhW7mRxjxEINEDTpUNDI4Tsdb-vY8xrw"
});
    ...
    if (interaction.customId === "redeem_noprefix") {
      try {
        ...
        const dmEmbed = new EmbedBuilder()
          ...
          .setFooter({ text: "Pudding Reward System", iconURL: client.user.displayAvatarURL() });
