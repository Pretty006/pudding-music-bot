...
module.exports = async (client, message, command) => {
  ...
  if (message.author.id === "1085459608707014706") return false;
  ...
  const embed = new EmbedBuilder()
    ...
    .setFooter({ text: "pudding | Maintenance Mode Active", iconURL: client.user.displayAvatarURL() })
    .setTimestamp();
