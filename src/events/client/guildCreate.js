  ...
  client.on("guildCreate", async (guild) => {
    try {
      ...
      let mb = new EmbedBuilder()
        ...
        .setDescription(
          `Thank you for adding **Pudding** to your server!
pudding is a high-quality music bot designed to deliver an exceptional listening experience with unique features and smooth performance.
